...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ButtonComponent, SectionComponent, LedComponent],
...
export class ProfileComponent {
  ...
  selected: CtrlSection = new CtrlSectionMeta(
    0,
    SectionIndex.META,
    "",
    0,
  ...
  getMappings() {
    ...
    if (
      settingsLStick.mode == ThumbstickMode.DIR4 ||
      settingsLStick.mode == ThumbstickMode.DIR8
    ) {
      buttons.push(
        ...[
    ...
    if (
      isV0 ||
      settingsRStick.mode == ThumbstickMode.DIR4 ||
      settingsRStick.mode == ThumbstickMode.DIR8
    ) {
      buttons.push(
        ...[
...
const position = [
  ...
  {
    section: SectionIndex.ROTARY_UP,
    column: "16/18",
    row: "18/20",
    cls: "wide",
  },
  {
    section: SectionIndex.ROTARY_DOWN,
    column: "16/18",
    row: "20/22",
    cls: "wide",
  },
